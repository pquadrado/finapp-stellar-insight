    ...
    <div className="h-full w-full flex flex-col items-center justify-center px-8 md:px-16 py-12">
      ...
      <div className="max-w-4xl w-full flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-4 text-slide-text-light animate-fade-in">
          ...
          <p className="text-base leading-relaxed">
            Após sete anos de experiência internacional na Espanha, trago uma visão ampla e estratégica para apoiar empreendedores e empresas na organização e crescimento de seus negócios por meio da Zamar AFV (Assistente Financeiro Virtual).
          </p>
        </div>
      </div>
    </div>
