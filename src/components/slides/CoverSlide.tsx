...
const CoverSlide = () => {
  return (
    <div className="h-full w-full flex flex-col items-center justify-center px-8">
      <img src={zamarLogo} alt="Zamar Consultoria Financeira" className="w-full max-w-xs mb-12 animate-scale-in" />
      <h1 className="text-3xl md:text-4xl text-center text-slide-text font-light max-w-3xl leading-relaxed animate-fade-in mb-6">
        ...
        <span className="text-slide-accent font-medium">A Zamar cuida disso para você.</span>
      </h1>
